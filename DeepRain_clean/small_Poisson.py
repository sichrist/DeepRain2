...
def param_layer_ZPoisson(
    ...
    layer = Conv2D(1, kernel_size=(3, 3), padding="same",activation="selu",
    ...
    input_dist = tf.keras.layers.Reshape((*ouput_shape,1))(layer_1)
...
def getModel():
    ...
    outputs = tfp.layers.IndependentPoisson(1)(outputs)
...
def train():
    ...
    plotHistory(history,history_path,title="small Poisson NLL-loss")
